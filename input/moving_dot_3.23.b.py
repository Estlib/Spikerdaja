...
stepcount = 0
element = 0
teachermove1 = [0,43,0,80, 0,100,80,0, 43,0,0,80, 100,0,80,0]
teachermove2 = [0,0,0,110, 0,0,110,0]
teachermove3 = [0,43,0,80, 0,100,80,0, 43,0,0,80, 100,0,80,0]
teachermove4 = [0,0,0,110, 0,0,110,0]
teachermove5 = [0,43,0,80, 0,100,80,0, 43,0,0,80, 100,0,80,0]
teachermove6 = [0,0,0,110, 0,0,110,0]
teachermove7 = [0,43,0,80, 0,100,80,0, 43,0,0,80, 100,0,80,0]
teachermove8 = [0,0,0,110, 0,0,110,0]
teachermove9 = [0,43,0,80, 0,100,80,0, 43,0,0,80, 100,0,80,0]
teachermove10 = [0,0,0,110, 0,0,110,0]
#up,down,left,right
...
def story2():
    worksheet()
    tahvel.create_text(160, 24, text="Teine kontrolltöö.", fill=PAL1, font=("terminal", 10))
...
def initialiseroom10():
    teachervariablereset()
    global currentlvteacher
    currentlvteacher = teachermove10
    global startX
    global startY
    global TstartX
    global TstartY
...
def end1():
    worksheet()
    tahvel.create_text(160, 24, text="Mäng Läbi", fill=PAL1, font=("terminal", 10))
    tahvel.create_text(160, 56, text="Oled meisterspikerdaja, nüüd vaata", fill=PAL1, font=("terminal", 10))
    tahvel.create_text(160, 72, text="kas saad tööl ka nii hakkama.", fill=PAL1, font=("terminal", 10))
    tahvel.create_text(160, 88, text="Õpetajatel ajasid muda keema,", fill=PAL1, font=("terminal", 10))
    tahvel.create_text(160, 104, text="nohik su sõber enam pole,", fill=PAL1, font=("terminal", 10))
    tahvel.create_text(160, 120, text="ema ja isa sooritasid sudoku.", fill=PAL1, font=("terminal", 10))
    tahvel.create_text(160, 136, text="", fill=PAL1, font=("terminal", 10))
    tahvel.create_text(160, 152, text="Oled rahul, tropp? GGEZ", fill=PAL1, font=("terminal", 10))
    global nooption
    nooption = 0
    time.sleep(0.200)
    while nooption < 1:
