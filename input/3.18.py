...
editorsave = 0 # todo: salvestusfunktsioon level editorile. funktsioon hetkel puudub
# ccm = None # unused value
playergraphic = None
teachergraphic = None
Tdesk = None
Sdesk1 = None
...
def story3():
    worksheet()
    tahvel.create_text(160, 24, text="Kolmas kontrolltöö.", fill=PAL1, font=("terminal", 10))
    tahvel.create_text(160, 56, text="story3", fill=PAL1, font=("terminal", 10))
...
def story4():
    worksheet()
    tahvel.create_text(160, 24, text="Neljas kontrolltöö.", fill=PAL1, font=("terminal", 10))
    tahvel.create_text(160, 56, text="story4", fill=PAL1, font=("terminal", 10))
    tahvel.create_text(160, 72, text="0", fill=PAL1, font=("terminal", 10))
    tahvel.create_text(160, 88, text="0", fill=PAL1, font=("terminal", 10))
    tahvel.create_text(160, 104, text="0", fill=PAL1, font=("terminal", 10))
    tahvel.create_text(160, 120, text="0", fill=PAL1, font=("terminal", 10))
...
def story5():
    worksheet()
    tahvel.create_text(160, 24, text="Viies kontrolltöö.", fill=PAL1, font=("terminal", 10))
    tahvel.create_text(160, 56, text="story5", fill=PAL1, font=("terminal", 10))
    tahvel.create_text(160, 72, text="0", fill=PAL1, font=("terminal", 10))
    tahvel.create_text(160, 88, text="0", fill=PAL1, font=("terminal", 10))
    tahvel.create_text(160, 104, text="0", fill=PAL1, font=("terminal", 10))
    tahvel.create_text(160, 120, text="0", fill=PAL1, font=("terminal", 10))
...
def story6():
    worksheet()
    tahvel.create_text(160, 24, text="Kuues kontrolltöö.", fill=PAL1, font=("terminal", 10))
    tahvel.create_text(160, 56, text="story6", fill=PAL1, font=("terminal", 10))
    tahvel.create_text(160, 72, text="0", fill=PAL1, font=("terminal", 10))
    tahvel.create_text(160, 88, text="0", fill=PAL1, font=("terminal", 10))
    tahvel.create_text(160, 104, text="0", fill=PAL1, font=("terminal", 10))
    tahvel.create_text(160, 120, text="0", fill=PAL1, font=("terminal", 10))
...
def story7():
    worksheet()
    tahvel.create_text(160, 24, text="Seitsmes kontrolltöö.", fill=PAL1, font=("terminal", 10))
    tahvel.create_text(160, 56, text="story7", fill=PAL1, font=("terminal", 10))
    tahvel.create_text(160, 72, text="0", fill=PAL1, font=("terminal", 10))
    tahvel.create_text(160, 88, text="0", fill=PAL1, font=("terminal", 10))
    tahvel.create_text(160, 104, text="0", fill=PAL1, font=("terminal", 10))
    tahvel.create_text(160, 120, text="0", fill=PAL1, font=("terminal", 10))
...
def story8():
    worksheet()
    tahvel.create_text(160, 24, text="Kaheksas kontrolltöö.", fill=PAL1, font=("terminal", 10))
    tahvel.create_text(160, 56, text="story8", fill=PAL1, font=("terminal", 10))
    tahvel.create_text(160, 72, text="0", fill=PAL1, font=("terminal", 10))
    tahvel.create_text(160, 88, text="0", fill=PAL1, font=("terminal", 10))
    tahvel.create_text(160, 104, text="0", fill=PAL1, font=("terminal", 10))
    tahvel.create_text(160, 120, text="0", fill=PAL1, font=("terminal", 10))
...
def story9():
    worksheet()
    tahvel.create_text(160, 24, text="Üheksas kontrolltöö.", fill=PAL1, font=("terminal", 10))
    tahvel.create_text(160, 56, text="story9", fill=PAL1, font=("terminal", 10))
    tahvel.create_text(160, 72, text="0", fill=PAL1, font=("terminal", 10))
    tahvel.create_text(160, 88, text="0", fill=PAL1, font=("terminal", 10))
    tahvel.create_text(160, 104, text="0", fill=PAL1, font=("terminal", 10))
    tahvel.create_text(160, 120, text="0", fill=PAL1, font=("terminal", 10))
...
def story10():
    worksheet()
    tahvel.create_text(160, 24, text="Lõpueksam", fill=PAL1, font=("terminal", 10))
    tahvel.create_text(160, 56, text="story10", fill=PAL1, font=("terminal", 10))
    tahvel.create_text(160, 72, text="0", fill=PAL1, font=("terminal", 10))
    tahvel.create_text(160, 88, text="0", fill=PAL1, font=("terminal", 10))
    tahvel.create_text(160, 104, text="0", fill=PAL1, font=("terminal", 10))
    tahvel.create_text(160, 120, text="0", fill=PAL1, font=("terminal", 10))
