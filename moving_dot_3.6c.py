...
startY=180 #mängija algusasukoht Y teljel, todo: muutujat muudetakse iga leveli alguses
...
def collisioncheck_studentdesklayout_2person():
    while Wcollision == 0 and Acollision == 0 and Scollision == 0 and Dcollision == 0:
        cc_sdl_2p_Sdesk1()
        while Wcollision == 0 and Acollision == 0 and Scollision == 0 and Dcollision == 0:
            cc_sdl_2p_Sdesk2()
            while Wcollision == 0 and Acollision == 0 and Scollision == 0 and Dcollision == 0:
...
#pseudocode for regionic collision checking:
#
#
#
#
